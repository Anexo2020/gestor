...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-3 col-3 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Cobranza</h3>
            <ol class="breadcrumb">
        ...
        <div class="col-md-6 col-5 align-self-center">
           <form id="validador">
                       ...
                       <?php endforeach ?>
                           ...
                           <input id="fecha" type="date" name="fecha" class="form-control col-md-3" /> 
                           <!-- Botón que hace la llamada a la función validarUsuario() para enviar formulario -->
                           <input class="button btn-info" onclick="cobroDelDia()" type="button" value="buscar" /> 
                        </form>
        </div>
