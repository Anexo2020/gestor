            ...
            <div class="card card-body printableArea">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="pull-left">
                            <address>
                                <h3 style="padding-bottom: 1px"> &nbsp;<b class="text-danger">Cobrador</b></h3>
                                <span ><select  class="form-control custom-select" id="cobrador" name="cobrador" aria-invalid="false">
                        ...
                        <div class="clearfix" style="padding-top: 60px">
                            <address>
                                <h3> &nbsp;</h3>
                                <input type="button" id="reca" class="btn btn-success" value="BUSCAR" /></form>
                            </address>
                        </div>
