        ...
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <!-- Card -->
                    <div class="card">
                        <img class="card-img-top img-responsive" src="<?php echo base_url() ?>assets/images/gallery/ventilador3en1.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h4 class="card-title">Lucia Lara Gonzalez</h4>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                        </div>
                    </div>
