...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Imagen</a></li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Seleccionar imagenes</h4>

                </div>
                <div class="card-body">
                    <?php echo form_open_multipart('admin/articulo/nuevaimagen');?>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
