                ...
                <div class="row">
                        ...
                        <div class="pull-left">
                            <address>
                                ...
                                <p class="text-muted m-l-5">Credito de referencia:--- <?php echo "CD000".$pago['idcredito']; ?>
                                    ...
                                    <br/> Pago ingresado por: <?php echo strtoupper($cob['cobro_name']." ".$cob['cobro_apellido']); ?></p>
                                    <?php endforeach ?> 
                            </address>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="pull-left m-t-30 text-left">
                            <hr>
                           <a href="javascript:verCreditosHoy()">  <button type="button" id="btnVerifCred" class="btn btn-rounded btn-info">Volver</button></a>
                        </div>
