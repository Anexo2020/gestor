                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9 controls">
                                            <div class="form-group has-success">
                                            <select class="form-control custom-select" name="role" data-placeholder="Choose a Category" aria-invalid="false">
                                            <option value="vendedor">vendedor</option>    
                                            <option value="administrador">administrador</option>
                                            <option value="supervisor_b">supervisor_b</option>
                                            <option value="verificador">verificador</option>
                                            <option value="supervisor_a">supervisor_a</option>
