                            ...
                            <?php  foreach ($users as $user): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="label label-table label-success"><a href="<?php echo base_url('admin/user/cargar_credito/'.$user['id']) ?>" data-toggle="tooltip" data-original-title="+ credito">Cargar Solicitud</div></a>
