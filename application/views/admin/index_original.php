                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                    ...
                                    <li><a href="<?php echo base_url('admin/user/power') ?>"><i class="fa fa-angle-right"></i> agregar roles</a></li>
                                    ...
                                    <li><a href="<?php echo base_url('admin/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> Lista Total</a></li>
                                    <li><a href="<?php echo base_url('admin/user/all_cliente_list') ?>"><i class="fa fa-angle-right"></i> Lista Clientes</a></li>
                                    <li><a href="<?php echo base_url('admin/user/all_creditos_list') ?>"><i class="fa fa-angle-right"></i> Creditos</a></li>
                                <?php else: ?>
                                    <?php if(check_power(5)):?>
                                    <li><a href="<?php echo base_url('admin/user/nuevocliente') ?>"><i class="fa fa-angle-right"></i> Nuevo Cliente </a></li>
